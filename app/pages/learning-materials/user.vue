<template>
  <main class="min-h-screen bg-white py-6 font-[Kanit]">
    ...
    >
      <div class="space-y-4">
        <div>
          <div class="mb-2 text-sm font-semibold text-slate-900">รหัสผู้ใช้งาน</div>
          <UInput v-model="formCode" size="xl" placeholder="เช่น LMU-001" class="w-full" :ui="inputUi" />
        </div>

        <div>
          <div class="mb-2 text-sm font-semibold text-slate-900">ชื่อ-นามสกุล</div>
          <UInput v-model="formFullName" size="xl" placeholder="เช่น ศุภชัย ใจดี" class="w-full" :ui="inputUi" />
        </div>

        <div>
          <div class="mb-2 text-sm font-semibold text-slate-900">อีเมล</div>
          <UInput v-model="formEmail" size="xl" placeholder="เช่น supachai@agency.go.th" class="w-full" :ui="inputUi" />
        </div>

        <div>
          <div class="mb-2 text-sm font-semibold text-slate-900">เบอร์ติดต่อ</div>
          <UInput v-model="formContact" size="xl" placeholder="เช่น 081-234-5678" class="w-full" :ui="inputUi" />
        </div>
